...
public class T_PURCHASE_MASTER {
    ...
    public void setSaleclassid(String saleclassid) {
        this.saleclassid = saleclassid == null ? null : saleclassid.trim();
    }
    ...
    public void setSaleclassname(String saleclassname) {
        this.saleclassname = saleclassname == null ? null : saleclassname.trim();
    }
    ...
    public void setPermittername(String permittername) {
        this.permittername = permittername == null ? null : permittername.trim();
    }
    ...
    public Integer getEaminestate() {
        return eaminestate;
    }

    public void setEaminestate(Integer eaminestate) {
        this.eaminestate = eaminestate;
    }
}