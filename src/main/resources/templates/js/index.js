...
layui.config({
	...
	function showNotice() {
		layer.open({
			...
			btn: ['好'],
			moveType: 1,
			content: '<div style="padding:15px 20px; text-align:justify; line-height: 22px; text-indent:2em;border-bottom:1px solid #e2e2e2;"><p>为保证稳定性，本次项目采用1.0.9版本，该版本为旧版本，帮助文档网址：<a href="https://www.layui.com/v1/doc" target="_blank">https://www.layui.com/v1/doc</a></p></div>',
